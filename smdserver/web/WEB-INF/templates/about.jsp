...
</p><p>Появилась идея, сделать инструмент, который ведёл&nbsp;бы рейтинг твоих слов и&nbsp;чаще напоминал пользователю слова, которые тот плохо знает. А&nbsp;те&nbsp;слова, которые пользователь запомнил хорошо, инструмент показывал&nbsp;бы реже.
