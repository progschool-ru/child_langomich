...
public class WordsData {
	...
	public void createWords(List<Word> words){
		//TODO РїРµСЂРµРёРјРµРЅРѕРІР°С‚СЊ РјРµС‚РѕРґ РІ sync
		...
		while(iter.hasNext()){
			...
			if(!translation.equals("")){
				...
				//TODO: СЃРґРµР»Р°С‚СЊ РїРѕСЃР»Рµ С‚РѕРіРѕ РєР°Рє РїРѕРґС‡РёРЅСЋ Р°РїРёС€РєСѓ РЅР° СЃРµСЂРІРµСЂРµ
			}
		}
	...
	public List<Word> getAllWords(){
		...
		//С‚СѓС‚ РЅР°РґРѕ РґРѕР±Р°РІРёС‚СЊ СѓСЃР»РѕРІРёРµ РїРµСЂРµРІРѕРґ != РїСѓСЃС‚РѕР№ СЃС‚СЂРѕРєРµ
