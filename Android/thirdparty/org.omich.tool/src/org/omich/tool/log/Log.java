...
public class Log 
{
	private static final String TPL_ME = "%1$s; %2$s"; //$NON-NLS-1$
	private static final String TPL_CE = "%1$s: %2$s"; //$NON-NLS-1$
	private static final String TPL_CM = TPL_CE;
	private static final String TPL_CME = "%1$s: %2$s; %2$s"; //$NON-NLS-1$
	...
	{
		d(bool ? Strings.BOOL_TRUE : Strings.BOOL_FALSE);
	}
