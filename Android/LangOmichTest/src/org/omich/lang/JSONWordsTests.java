...
public class JSONWordsTests extends AndroidTestCase {
	...
	private static final String original = "привет";
	...
	public void testJSONWords(){
		
		
		List<Word> words = new ArrayList<Word>();
		words.add( new Word(original,translation,rating,modified) );
		words.add( new Word("пока", "by", 0, 12344) );
		
	
		
		JSONWords jsonWords = new JSONWords(words);
	}
